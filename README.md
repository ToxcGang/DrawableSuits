...
- Active editor diagnostics report full proxy mesh/collider state through `WorldProxyMeshValidation`, `WorldProxyWeldedComponent`, `WorldAvatarProxy updated`, and optional `WorldProxyHelmetShellRejected`, `WorldProxySourceFallback`, `WorldProxyCleanupPlanned`, `WorldProxyCleanupApplied`, `WorldProxyCleanupSkippedUnsafe`, or `WorldProxyCleanupFailSafeFullMesh`; `PartClassifierBuilt` should not appear during normal editor use.
