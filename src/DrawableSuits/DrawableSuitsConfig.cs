...
internal sealed class DrawableSuitsConfig
{
    ...
    public DrawableSuitsConfig(ConfigFile config)
    {
        ...
        ShowStartupDiagnostics = config.Bind("Diagnostics", "ShowStartupDiagnostics", false, "Show a small DrawableSuits loaded/debug HUD for a short time after startup. Disabled by default in 0.4.2; press F9 for the debug HUD.");
        ...
        EnableOsFileDialog = config.Bind("Decals", "EnableOsFileDialog", false, "Disabled/experimental. In-game OS file dialogs are ignored in 0.4.2; place PNG/JPG decals in the Decals folder and press Refresh Decals.");
